    ...
    return (
      <div className="current-rest" >
        <div className="child-current">
          ...
          <p>
            Photo: <img src={`https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${this.props.restaurantProp.photos ? this.props.restaurantProp.photos[0].photo_reference : null}&key=`} />
          </p>
         </div>
      </div>
    );
